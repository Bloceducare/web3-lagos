      ...
      <div className="border border-black rounded-lg w-full bg-white lg:px-8 pt-6 pb-8 mb-4 shadow-[6px_6px_0px_0px_#1ACF2C]">
        ...
        <form onSubmit={handleSubmit} className="">
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-6 sm:space-x-6 sm:space-y-0">
            <div className="w-full sm:w-full">
              ...
              <input
                ...
                required
              />
              {errors.first_name && <p className="text-red-500 text-sm absolute">{errors.first_name}</p>}
            </div>
            <div className="w-full sm:w-full">
              ...
              <input
                ...
                required
              />
              {errors.other_name && <p className="text-red-500 text-sm absolute">{errors.other_name}</p>}
            </div>
          </div>
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-6 sm:space-x-6 sm:space-y-0">
            <div className="w-full sm:w-full">
              <label htmlFor="email" className="block mb-2 font-bold text-gray-600 my-8">
                Email
              </label>
              <input
                type="email"
            ...
            <div className="w-full sm:w-full">
              <label htmlFor="github_username" className="block mb-2 font-bold text-gray-600 my-8">
                Github Username
              </label>
              <input
                type="text"
              ...
              {errors.github_username && (
                <p className="text-red-500 text-sm absolute">{errors.github_username}</p>
              )}
            </div>
          </div>
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-6 sm:space-x-6 sm:space-y-0">
            <div className="w-full sm:w-1/2">
              <label htmlFor="password" className="block mb-2 font-bold text-gray-600 my-8">
                Password
              </label>
            ...
            <div className="w-full sm:w-1/2">
              <label htmlFor="confirmpassword" className="block mb-2 font-bold text-gray-600 my-9">
                Confirm Password
              </label>
              <div className="relative w-full">
                <input
              ...
              {errors.confirmpassword && (
                <p className="text-red-500 text-sm absolute">{errors.confirmpassword}</p>
              )}
            </div>
          </div>
          <div className="mb-4">
          ...
          <div className="mb-16 ">
            ...
            {errors.hacking_role && (
              <p className="text-red-500 text-sm absolute">{errors.hacking_role}</p>
            )}
          </div>
          <button
            type="submit"
            className={`w-full p-5 bg-[#1E1E1E] text-center shadow-[-5px_-5px_0px_0px_#0096FF] text-white font-bold rounded-lg hover:bg-green-600 transition duration-300 ${isSubmitDisabled ? "opacity-50 cursor-not-allowed" : ""
              }`}
