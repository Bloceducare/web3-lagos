...
export default function ResetPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const response = await fetch(
      "https://giant-dorice-web3bridge-89722e9a.koyeb.app/users/complete-reset-password/",
      {
        method: "POST",
        headers: {
  ...
  return (
    <main className=" relative flex flex-col min-h-screen w-full overflow-hidden ">
      <BackgroundColor />
      <div className="relative mx-auto mt-10 max-w-3xl p-6">
        <div className="border border-black rounded-lg w-full bg-[#fff] lg:px-8 pt-6 pb-8 mb-4 shadow-[6px_6px_0px_0px_#1ACF2C]">
          ...
          <h3 className="mb-8">
            Enter your new password and confirm it to complete the password
            reset process.
          </h3>
